 ...
 */
public class MusicInsertDB extends AsyncTask<ArrayList<MusicInfo>, Integer, Void> {
    ...
    public MusicInsertDB(DataBase dataBase, Context context){
    ...
    protected Void doInBackground(ArrayList<MusicInfo>... params) {
        ...
        for (int i=0; i<sizeList; i++){
            ...
            String newPath = changeName.changePathPlus(item.getPath());
            dataBase.insertMusicInfoToDataBase(item.getPath(), newPath, item.getName());
            publishProgress(i);
        }
