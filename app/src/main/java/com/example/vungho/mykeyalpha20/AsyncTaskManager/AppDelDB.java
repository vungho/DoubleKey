 ...
 */
public class AppDelDB extends AsyncTask<ArrayList<AppInfo>, Integer, Void> {
    private DataBase dataBase;
    private Context context;
    private ProgressDialog dialog;
    private ArrayList<AppInfo> list;

    public AppDelDB(DataBase dataBase, Context context){
    ...
    protected Void doInBackground(ArrayList<AppInfo>... params) {
        ...
        for (int i=0; i<sizeList; i++){
            dataBase.queryData("delete from app where packagename = '"
