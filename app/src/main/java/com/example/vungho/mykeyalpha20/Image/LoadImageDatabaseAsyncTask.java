 ...
 */
public class LoadImageDatabaseAsyncTask extends AsyncTask<String, Void, Bitmap> {

    private Context context;
    private final WeakReference<ImageView> imageViewWeakReference;

    public LoadImageDatabaseAsyncTask(Context context, ImageView imageView) {
    ...
    protected Bitmap doInBackground(String... params) {
        ...
        Cursor cursor = new DataBase(context).
                getData("select avatar from image where path = '" + uri + "'");
        cursor.moveToFirst();
